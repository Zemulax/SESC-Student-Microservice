...
public class TopicSearchController {
    ...
    @GetMapping("/externalStudentId/{externalStudentId}")
    public ResponseEntity<List<Topic>> searchAllTopicByStudentId(@PathVariable String externalStudentId) {
        List<Topic> topics = topicService.searchAllTopicByStudentId(externalStudentId);
